...
import com.team2.activity.entity.enums.RecordType; // 활동 유형 열거형 (MEETING, ISSUE, MEMO, SCHEDULE)
...
public class Activity {
    ...
    private RecordType type;        // 활동 유형 (미팅/협의, 이슈, 메모/노트, 일정)
    ...
    private Activity(Long clientId, RecordType type, String title, String content,
    ...
    public void update(RecordType type, String title, String content, LocalDate date,
