...
// 활동 우선순위 열거형 (DB ENUM: '높음','보통') - 이슈 타입에서만 사용
public enum Priority {
    HIGH("높음"),   // 높은 우선순위 - 긴급하게 처리해야 할 이슈
    MEDIUM("보통"); // 보통 우선순위 - 일반적인 이슈
