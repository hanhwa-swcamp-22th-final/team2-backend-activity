...
(1, 'PO001', 1, '2026-03-01', 'meeting', '글로벌 스틸 초기 미팅', '거래처 담당자와 첫 미팅 진행. 제품 소개 및 가격 협의.', NULL, NULL, NULL, NOW(), NOW()),
(1, 'PO001', 1, '2026-03-05', 'memo', '글로벌 스틸 미팅 후기', '미팅 결과 정리. 샘플 요청 확인.', NULL, NULL, NULL, NOW(), NOW()),
(2, 'PO002', 2, '2026-03-10', 'meeting', '아시아 무역 견적 협의', '견적서 기반 가격 협의. 물류비 별도 논의 필요.', NULL, NULL, NULL, NOW(), NOW()),
(2, 'PO002', 2, '2026-03-12', 'issue', '아시아 무역 납기 지연', '원자재 수급 문제로 납기 2주 지연 예상.', 'high', NULL, NULL, NOW(), NOW()),
(3, 'PO003', 1, '2026-03-15', 'meeting', '유럽 트레이딩 계약 논의', '연간 계약 조건 논의. MOQ 및 결제 조건 확인.', NULL, NULL, NULL, NOW(), NOW()),
(3, 'PO003', 3, '2026-03-18', 'memo', '유럽 트레이딩 계약서 검토', '법무팀 계약서 검토 요청 완료.', NULL, NULL, NULL, NOW(), NOW()),
(1, 'PO001', 2, '2026-03-20', 'issue', '글로벌 스틸 품질 이슈', '납품 제품 일부 규격 미달. 교체 배송 진행.', 'normal', NULL, NULL, NOW(), NOW()),
(4, 'PO004', 3, '2026-03-22', 'schedule', '동남아 물산 공장 방문', '베트남 공장 실사 일정.', NULL, '2026-04-01', '2026-04-03', NOW(), NOW()),
(4, 'PO004', 3, '2026-03-25', 'meeting', '동남아 물산 가격 재협상', '환율 변동으로 인한 가격 재협상 요청.', NULL, NULL, NULL, NOW(), NOW()),
(2, 'PO002', 1, '2026-03-28', 'schedule', '아시아 무역 분기 리뷰', '1분기 거래 실적 리뷰 미팅.', NULL, '2026-04-05', '2026-04-05', NOW(), NOW());
...
(1, 'PO001', '글로벌 스틸 견적서 발송', '김철수', 'chulsoo.kim@globalsteel.com', 1, 'sent', NOW(), NOW()),
(1, 'PO001', '글로벌 스틸 PI 발송', '이영희', 'younghee.lee@globalsteel.com', 1, 'sent', NOW(), NOW()),
(2, 'PO002', '아시아 무역 CI 발송', '박민수', 'minsoo.park@asiatrade.com', 2, 'sent', NOW(), NOW()),
(2, 'PO002', '아시아 무역 PL 발송', '최지은', 'jieun.choi@asiatrade.com', 2, 'failed', NULL, NOW()),
(3, 'PO003', '유럽 트레이딩 계약서 발송', '정하늘', 'haneul.jung@eurotrading.com', 1, 'sent', NOW(), NOW()),
(3, 'PO003', '유럽 트레이딩 PI 발송', '한서연', 'seoyeon.han@eurotrading.com', 3, 'sent', NOW(), NOW()),
(4, 'PO004', '동남아 물산 생산지시서 발송', '강동원', 'dongwon.kang@seasia.com', 3, 'failed', NULL, NOW()),
(4, 'PO004', '동남아 물산 선적지시서 발송', '윤서준', 'seojun.yoon@seasia.com', 3, 'sent', NOW(), NOW()),
(1, 'PO001', '글로벌 스틸 수정 견적서', '김철수', 'chulsoo.kim@globalsteel.com', 2, 'sent', NOW(), NOW()),
(2, 'PO002', '아시아 무역 납기 안내', '임재현', 'jaehyun.lim@asiatrade.com', 1, 'sent', NOW(), NOW());
...
('글로벌 스틸 3월 활동 보고서', '3월 글로벌 스틸 관련 영업 활동 종합', 'PO001', 1, '2026-03-01', '2026-03-31', NOW(), NOW()),
('아시아 무역 3월 활동 보고서', '3월 아시아 무역 관련 영업 활동 종합', 'PO002', 2, '2026-03-01', '2026-03-31', NOW(), NOW()),
('유럽 트레이딩 계약 패키지', '유럽 트레이딩 계약 관련 활동 모음', 'PO003', 1, '2026-03-15', '2026-03-31', NOW(), NOW()),
('동남아 물산 4월 일정', '동남아 물산 공장 방문 및 협상 일정', 'PO004', 3, '2026-04-01', '2026-04-30', NOW(), NOW()),
('1분기 이슈 모음', '1분기 발생한 주요 이슈 정리', NULL, 1, '2026-01-01', '2026-03-31', NOW(), NOW()),
('글로벌 스틸 품질 이슈 패키지', '품질 관련 이슈 및 대응 기록', 'PO001', 2, '2026-03-01', '2026-03-31', NOW(), NOW()),
...
('아시아 무역 납기 관리', '납기 지연 이슈 및 후속 조치 기록', 'PO002', 1, '2026-03-01', '2026-03-31', NOW(), NOW()),
